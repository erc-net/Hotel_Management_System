...
class HotelManagementSystem:
  def __init__(self,root):
    ...
    self.root.geometry("1528x800+0+0")
    
    
    
    #========================1ST IMG============================
    img1=Image.open(r"C:\Users\Israel\Desktop\hotel systems project\images\bac1.jpg")
    img1=img1.resize((1528,140),Image.LANCZOS)
    self.photoimg1=ImageTk.PhotoImage(img1)
    
    lblimg=Label(self.root,image=self.photoimg1,bd=4,relief=RIDGE)
    lblimg.place(x=0,y=0,width=1528,height=140)
    
    #=======================logo================================
    img2=Image.open(r"C:\Users\Israel\Desktop\hotel systems project\images\logo.png")
    ...
    lbl_title.place(x=0,y=140,width=1528,height=50)
    
    #=====================MAIN FRAME========================
    main_frame=Frame(self.root,bd=4,relief=RIDGE)
    main_frame.place(x=0,y=190,width=1528,height=620)
    ...
    #==================RIGHT SIDE IMAGE==============
    img3=Image.open(r"C:\Users\Israel\Desktop\hotel systems project\images\lobby.jpg")
    ...
    #================Down images==================
    img4=Image.open(r"C:\Users\Israel\Desktop\hotel systems project\images\hotels.jpg")
    ...
    img5=Image.open(r"C:\Users\Israel\Desktop\hotel systems project\images\food.jpg")
